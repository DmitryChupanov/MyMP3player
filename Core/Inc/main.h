...
#define TFT_Brightnes_Pin GPIO_PIN_4
#define TFT_Brightnes_GPIO_Port GPIOE
...
#define XRESET_Pin GPIO_PIN_1
#define XRESET_GPIO_Port GPIOB
#define BtnPlus_Pin GPIO_PIN_2
#define BtnPlus_GPIO_Port GPIOB
#define BtnMinus_Pin GPIO_PIN_7
#define BtnMinus_GPIO_Port GPIOE
#define BtnMode_Pin GPIO_PIN_8
#define BtnMode_GPIO_Port GPIOE
